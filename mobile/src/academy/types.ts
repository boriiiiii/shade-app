...
/**
 * Un chapitre d'une leçon.
 *
 * La maquette Figma présente une leçon comme une suite de chapitres que l'on
 * fait défiler horizontalement. Les leçons sont rédigées en blocs continus :
 * les chapitres en sont dérivés à la lecture (cf. `toChapters`), ce qui évite
 * de dupliquer le contenu dans deux formats.
 */
export interface LessonChapter {
  /** Titre affiché en tête du chapitre. */
  title: string;
  /** Les blocs qui composent ce chapitre. */
  blocks: LessonBlock[];
}
